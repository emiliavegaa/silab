...
class RiwayatPeminjamanBarangScreen extends StatelessWidget {
  const RiwayatPeminjamanBarangScreen({super.key});
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<PeminjamanProvider>(context);
                        ...
                        showDialog(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                _buildDetailRow(Icons.build_rounded, 'Barang',
                                    item.namaBarang),
                                const SizedBox(height: 8),
                                _buildDetailRow(Icons.numbers_rounded, 'Jumlah',
                                    '${item.jumlah}'),
                                const SizedBox(height: 8),
                                _buildDetailRow(Icons.schedule_rounded,
                                    'Durasi', '${item.durasiJam} jam'),
                                const SizedBox(height: 8),
                                _buildDetailRow(Icons.calendar_today_rounded,
                                    'Tanggal Pengajuan', item.tanggal),
                                const SizedBox(height: 8),
                                _buildDetailRow(Icons.edit_note_rounded,
                                    'Alasan', item.alasan),
                                const SizedBox(height: 8),
                                _buildDetailRow(
